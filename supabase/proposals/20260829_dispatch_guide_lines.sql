-- APPROVED / PROMOTED TO MIGRATION 045 — NOT EXECUTED.
-- Canonical execution file:
--   supabase/migrations/045_default_dispatch_guide_template.sql
-- Platform Phase 5: fixed/default Dispatch Guide template with repeated products.
--
-- This proposal was prepared from read-only discovery against project
...
--     intentionally NOT introduced by this proposal.
