...
export const notifications = {
  ...
  dispatchAdded: { title: "Despachos agregados" },
  ...
  reconciliationDifferences: { title: "Refacturación requerida", description: "Se detectaron diferencias y el despacho pasó automáticamente a refacturación." },
